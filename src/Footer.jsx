...
export default function Footer() {
    ...
    return (<>
        ...
        <div id="footer-div2">
            ...
            <span id="contact">
                <h3>Contact US</h3>
                <dt style={{ display: "inline" }}>Call us:</dt><dl style={{ display: "inline" }}>&emsp;+91 99999 11111</dl>
                <br />
                <dt style={{ display: "inline" }}>Mail us:</dt><dl style={{ display: "inline" }}>&emsp;aniruddh@gmail.com</dl>
            </span>
        </div>
    </>
    )
